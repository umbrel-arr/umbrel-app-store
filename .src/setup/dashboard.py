...
<main>
  ...
  <div class="meta-row"><span>Managed scope: this Umbrel and shared network media</span><span id="fresh">Not checked yet</span></div>
...
load().catch(error=>{document.getElementById('healthTitle').textContent='Status unavailable';document.getElementById('healthDetail').textContent=error.message;});
