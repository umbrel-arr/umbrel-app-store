...
class ReconcilerTests(unittest.TestCase):
    ...
    def test_settings_define_hd_and_4k_instances(self):
        ...
        self.assertEqual(instances["sonarr"], ("/media/series", "tv", False))
        self.assertEqual(instances["sonarr-4k"], ("/media/series-4k", "tv-4k", True))
        self.assertEqual(instances["radarr"], ("/media/movies", "movies", False))
        self.assertEqual(instances["radarr-4k"], ("/media/movies-4k", "movies-4k", True))
        self.assertEqual(instances["lidarr"], ("/media/music", "music", False))
    ...
    def test_servarr_configuration_is_idempotent(self):
        ...
        reconciler.configure_arr(arr)
        self.assertEqual(client.roots, [{"path": "/media/movies", "id": 1}])
